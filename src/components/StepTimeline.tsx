...
const opColors: Record<string, string> = {
  idle: 'timeline-idle',
  enqueue: 'timeline-enqueue',
  dequeue: 'timeline-dequeue',
  peek: 'timeline-peek',
}
...
const StepTimeline = ({ steps, currentStep, onStepSelect }: StepTimelineProps) => {
  return (
    <div className="step-timeline" role="navigation" aria-label="Step navigation timeline">
